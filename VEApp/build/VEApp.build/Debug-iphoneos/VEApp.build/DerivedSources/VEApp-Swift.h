...
#ifndef VEAPP_SWIFT_H
#define VEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VEApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5VEApp11AppDelegate")
...
SWIFT_CLASS("_TtC5VEApp13SceneDelegate")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified tripFuelEfficiencyLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified engineTemperatureLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified outsideTemperatureLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified issuesLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified faultsLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified driverNameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified driverIdLabel;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified fuelLevelLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified adBlueLevelLabel;
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified truckDetailView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified leftLabelView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified registrationLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified bottomLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified statusLabelImg;
...
SWIFT_CLASS("_TtC5VEApp14ViewController")
